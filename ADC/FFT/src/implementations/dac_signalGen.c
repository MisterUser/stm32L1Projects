...
void DAC_TIM_Config(void)
{
  ...
  TIM_TimeBaseStructure.TIM_Period = 1000;//1MHz/1000=1,000,000/1,000 = 1,000Hz = 1kHz
  TIM_TimeBaseStructure.TIM_Prescaler = 0x4;//1MHz
  TIM_TimeBaseStructure.TIM_ClockDivision = TIM_CKD_DIV4; //4MHz
...
void DAC_signalGen_init(void)
{
   ...
   DAC_InitStructure.DAC_LFSRUnmask_TriangleAmplitude =DAC_WaveGeneration_None;//same as 0x0
